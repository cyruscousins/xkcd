...
public class HatGuy extends Character{
	Image image;
	
	public HatGuy(World world, Controller control, float x, float y, float mass, float radius){
		super(world, control, x, y, mass, radius);
		image = ResourceManager.getImage("res/img/hatguy.png", BufferedImage.TYPE_INT_ARGB);
	}
