...
public class Noise{
	...
	public static SVF noiseSVF(int width, float scale, float min, float max){
		return new MappedSVF(genNoise2f(width, .94f, 30, 31, 1, 1, 0, 255), width, scale);
	...
	public static float fastSine(float theta) {
		...
		if (theta < -3.14159265f) {
			do theta += 6.28318531f; while(theta < -3.14159265f);
	...
	public static MappedSVF3D noiseSVF3D(int width, float scale, float min, float max){
		return new MappedSVF3D(genNoise3f(width, .95f, 35, 31, 1, 1, min, max), width, scale);
		//return new MappedSVF(genNoise2f(width, .93f, 30, 31, 1, 1, 0, 255), width, scale); //excellent noisey noise map
		//return new MappedSVF(genNoise2f(width, .7f, 11, 15, 1, 1, 0, 255), width, scale); //nice noisemap
		//return new MappedSVF(genNoise2f(width, .1f, 2, 31, 1, 1, 0, 255), width, scale); //testing striped map
	}
